...
async def start(bot, m: Message):
    ...
    start_message = await bot.send_photo(
        chat_id=m.chat.id,
        photo="https://ar-hosting.pages.dev/1752942111453.jpg",
        caption=caption
    )
    ...
    if m.chat.id in AUTH_USERS:
        keyboard = InlineKeyboardMarkup([
            ...
            [InlineKeyboardButton(text="📞 Contact", url="https://t.me/Contact_AdminSbot"), InlineKeyboardButton(text="🤖 Updates", url="https://t.me/StackSadhubots")],
        ])
        ...
        await start_message.edit_text(
            ...
            f"If you face any problem contact -  [**🖤⃝𝐒𝐨𝐧𝐮**⁬](https://t.me/Contact_AdminSbot)\n", disable_web_page_preview=True, reply_markup=keyboard
        )
    else:
...
async def help_button(client, callback_query):
  ...
  await callback_query.message.edit_media(
    InputMediaPhoto(
      media="https://ar-hosting.pages.dev/1752942112328.jpg",
      caption=caption
    ),
    reply_markup=keyboard
    )
...
async def help_button(client, callback_query):
  ...
  await callback_query.message.edit_media(
    InputMediaPhoto(
      media="https://ar-hosting.pages.dev/1752942113175.jpg",
      caption=caption
    ),
    reply_markup=keyboard
  )
...
async def upgrade_button(client, callback_query):
  ...
  caption = (
           ...
           f"If you want to buy membership of the bot, feel free to contact [{CREDIT}](t.me/Contact_AdminSbot)\n"
    )  
    
  await callback_query.message.edit_media(
    InputMediaPhoto(
      media="https://ar-hosting.pages.dev/1752942104883.jpg",
      caption=caption
    ),
    reply_markup=keyboard
    )
...
async def settings_button(client, callback_query):
    ...
    await callback_query.message.edit_media(
    InputMediaPhoto(
      media="https://ar-hosting.pages.dev/1752942106446.jpg",
      caption=caption
    ),
    reply_markup=keyboard
    )
...
async def cmd(client, callback_query):
    ...
    await callback_query.message.edit_media(
    InputMediaPhoto(
      media="https://ar-hosting.pages.dev/1752942103004.jpg",
      caption=caption
    ),
    reply_markup=keyboard
    )
...
async def cmd(client, callback_query):
    ...
    await callback_query.message.edit_media(
    InputMediaPhoto(
      media="https://ar-hosting.pages.dev/1752942103938.jpg",
      caption=caption
    ),
    reply_markup=keyboard
    )
...
async def id_command(client, message: Message):
    keyboard = InlineKeyboardMarkup([[InlineKeyboardButton(text="Send to Owner", url="https://t.me/Contact_AdminSbot")]])
...
async def info(bot: Client, update: Message):
    keyboard = InlineKeyboardMarkup([[InlineKeyboardButton(text="📞 Contact", url="https://t.me/Contact_AdminSbot")]])
    text = (
        f"╭────────────────╮\n"
